                ...
                <div class="col-xl-6 col-lg-7 col-md-8 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-center bg-transparent">
                            ...
                            <span >
                                <img src="{{ asset('assets') }}/img/binkan.png" style="width:180px; height:100px" alt="main_logo">
                            </span>

                            {{-- <h3 class="font-weight-bolder text-info text-gradient">{{ __('BinKan Smart Waste Monitoring System') }}</h3> --}}
