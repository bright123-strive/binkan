          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Bins</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Over 50% fill level</p>
                    <h5 class="font-weight-bolder mb-0">
                      0
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Over 85% Fill Level</p>
                    <h5 class="font-weight-bolder mb-0">
                      1
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total Trucks</p>
                    <h5 class="font-weight-bolder mb-0">
                      6
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Sensor Power Consumption in mA</h6>
                ...
                <div class="row">
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Temperature</p>
                    </div>
                    <h4 class="font-weight-bolder">36 °C</h4>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Humidity</p>
                    </div>
                    <h4 class="font-weight-bolder">2 GPC</h4>
                    <div class="progress w-75">
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Total Volts</p>
                    </div>
                    <h4 class="font-weight-bolder">5 V</h4>
                    <div class="progress w-75">
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Capacitance </p>
                    </div>
                    <h4 class="font-weight-bolder">56 µF</h4>
                    <div class="progress w-75">
        ...
        <div class="col-lg-7">
          <div class="card">
            <div class="card-header pb-0">
              <h6>Bin Collection Overview</h6>
              <p class="text-sm">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold">4% more</span>2023
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-0">
            <table class="table align-items-center justify-content-center mb-0">
              <thead>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Bin Sensor ID</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Location</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Status</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">Fill Level</th>
                  <th></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex px-2">
                      ...
                      <div class="my-auto">
                        <h6 class="mb-0 text-sm">BINS001</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                    <p class="text-sm font-weight-bold mb-0">Chichiri Shoprite</p>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="d-flex px-2">
                      ...
                      <div class="my-auto">
                        <h6 class="mb-0 text-sm">BINS002</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                  ...
                  <td class="align-middle text-center">
                    <div class="d-flex align-items-center justify-content-center">
                      ...
                      <div>
                        <div class="progress">
                          <div class="progress-bar bg-gradient-warning" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 85%;"></div>
                        </div>
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  <td>
                    <div class="d-flex px-2">
                      ...
                      <div class="my-auto">
                        <h6 class="mb-0 text-sm">BINS003</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="d-flex px-2">
                      ...
                      <div class="my-auto">
                        <h6 class="mb-0 text-sm">BINS004</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="d-flex px-2">
                      ...
                      <div class="my-auto">
                        <h6 class="mb-0 text-sm">BINS005</h6>
                      </div>
                    </div>
                  </td>
                  <td>
                    <p class="text-sm font-weight-bold mb-0">MUBAS</p>
                  </td>
                  <td>
                  ...
                  <td class="align-middle text-center">
                    <div class="d-flex align-items-center justify-content-center">
                      ...
                      <div>
                        <div class="progress">
                          <div class="progress-bar bg-gradient-success" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: 2%;"></div>
                        </div>
                      </div>
                    </div>
                  </td>
