          ...
          <div class="row">
              <div class="col-8 mx-auto text-center mt-1">
                  <p class="mb-0 text-secondary">
                      Copyright © {{ now()->year }} Powered By <a style="color: #252f40;" href="https://www.innovexmw.com"
                          class="font-weight-bold ml-1" target="_blank">Innovex Malawi</a> &amp; <a style="color: #252f40;"
